      ...
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md space-y-6">
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            <a href="https://github.com/Seahawk-Media/seaport" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">View on GitHub</a>
          </p>
        </div>
      </div>
    </div>
